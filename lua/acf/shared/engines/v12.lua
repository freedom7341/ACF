...
ACF_DefineEngine( "4.6-V12", {
	...
	weight = 188,
	torquearray = {0.1, 0.3, 0.6, 0.8, 1, 0.7},
	torque = 235,
	flywheelmass = 0.2,
	idlerpm = 1000,
	peakminrpm = 4500,
...
ACF_DefineEngine( "7.0-V12", {
	...
	enginetype = "GenericPetrol",
	weight = 360,
	torquearray = {0.2, 0.3, 0.6, 0.8, 1, 0.7},
	torque = 500,
	flywheelmass = 0.45,
	idlerpm = 800,
	peakminrpm = 3600,
...
ACF_DefineEngine( "23.0-V12", {
	...
	enginetype = "GenericPetrol",
	weight = 1350,
	torquearray = {0.3, 0.5, 0.7, 1, 0.8, 0.6},
	torque = 1925,
	flywheelmass = 5,
	idlerpm = 600,
	peakminrpm = 1500,
...
ACF_DefineEngine( "4.0-V12", {
	...
	weight = 305,
	torquearray = {0.1, 0.5, 0.7, 1, 0.8, 0.6},
	torque = 375,
	flywheelmass = 0.475,
	idlerpm = 650,
	peakminrpm = 1200,
...
ACF_DefineEngine( "21.0-V12", {
	...
	enginetype = "GenericDiesel",
	weight = 1800,
	torquearray = {0.2, 0.5, 0.8, 1, 0.8, 0.6},
	torque = 3560,
	flywheelmass = 7,
	idlerpm = 400,
	peakminrpm = 500,
